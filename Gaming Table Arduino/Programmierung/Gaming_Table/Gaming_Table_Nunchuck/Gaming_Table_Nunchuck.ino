...
void start_screen() {
  ...
  for (int i = 0; i < MAXLED; i++) {  //Home blauer Regenschirm
    ...
    if (i == 727 || i == 825 || i == 777 || i == 728 || i == 774 || i == 822 || i == 870 || i == 918 || i == 966 || i == 1014 || i == 1062 || i == 1110 || i == 1157 || i == 1108 || i == 1107 || i == 1154 || i == 1105 || i == 1153 || i == 1201 || i == 1250 || i == 1299 || i == 1348 || i == 1349 || i == 1350 || i == 1351 || i == 1352 || i == 1305 || i == 1258 || i == 1211 || i == 1163 || i == 1162 || i == 1115 || i == 1113 || i == 1112 || i == 1159) {
